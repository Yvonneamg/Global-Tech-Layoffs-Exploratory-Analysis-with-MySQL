...
Alter table layoff_staging2
add column Fundsraised int;
Alter table layoff_staging2
add column Fundsraised2 text;
Update layoff_staging2
set Fundsraised2=substring(funds_raised,2,length(funds_raised));
alter table layoff_staging2
drop column Fundsraised;
update layoff_staging2
set Fundsraised2=0
where Fundsraised2 is null or Fundsraised2='';
alter table layoff_staging2
modify column Fundsraised2 int;
alter table layoff_staging2
